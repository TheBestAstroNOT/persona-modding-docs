...
* [Yona Music Manager](https://github.com/T-PoseRatkechi/phos-music-manager/releases)
...
![test alt text!](/assets/images/audio/r2_bgme.png)
...
The encoder should be set to ADX (Persona 5 Royal PC). If you do not have this option, follow [this](./audio-replacement#p5r-adx-encryption) to install it.
