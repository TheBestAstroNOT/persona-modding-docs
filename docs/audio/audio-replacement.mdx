...
- P5R ADX encryption script (if editing P5R audio!)
	- <a href="/assets/download/adx-p5r-pc.ini" download="adx-p5r-pc.ini" target="_blank">adx-p5r-pc.ini</a> (for usage with Phos Music Manager)
...
![](/assets/images/audio/phosmusicmanager.png)
...
![](/assets/images/audio/phosnewproject.png)
...
![](/assets/images/audio/phosencodetool.png)

<a href="/assets/download/adx-p5r-pc.ini" download="adx-p5r-pc.ini" target="_blank">Download adx-p5r-pc.ini here</a> and save it to the directory that was just opened. Alternatively, create a new text file named adx-p5r-pc.ini and paste the following into it:
...
![](/assets/images/audio/phosreplacement.png)

Set your start and end loop points in the Start Sample and End Sample boxes. More information on this can be found in the [Audio Editing and Formatting page](https://www.google.com/) MISSING LINK!!!.
...
![](/assets/images/audio/phosbuild.png)
...
![](/assets/images/audio/phosfolder.png)
...
![](/assets/images/audio/atomencd.png)
...
<Tabs>
  <TabItem value="encryptps" label="Powershell">
```
...
<TabItem value="encryptwine" label="Wine">
```
...
<Tabs>
<TabItem value="decryptps" label="Powershell">
``` powershell
...
<TabItem value="decryptwine" label="Wine">
```
...
If modding P3F or P3P on PC, you can simply [replace the corresponding files](../Getting Started/replacing-files.mdx). For P4G and P5R, the files should be named according to their streaming ID; the file naming format is `(streaming ID - 1)_(whatever you want here)`.
...
<Tabs>
<TabItem value="awbemulatorp4g" label="P4G">
...
<TabItem value="awbemulatorp5r" label="P5R">
...
<TabItem value="awbemulatorp3p" label="P3P">
...
<TabItem value="awbemulatorp3f" label="P3F">
...
![](/assets/images/audio/foobar-example.png)
