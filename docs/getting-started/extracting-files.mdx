...
![](/assets/images/getting-started/personaeditor.png)
...
<Tabs>
<TabItem value="unpack-cmd" label="Command Prompt">
```bat
for /R "Path\To\Folder" %i in (*.bin) do "Path\To\PAKPack.exe" unpack %i
```
</TabItem>

<TabItem value="unpack-ps" label="PowerShell">
```powershell
...
![](/assets/images/getting-started/fmodel_ebd9hxtt5s.png)
...
![](/assets/images/getting-started/fmodel_985mxhyhpn.png)
