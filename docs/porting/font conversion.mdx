...
First, download your font and open it in Persona Editor, the file should be called font0.fnt. 
  ...
  ![](/assets/images/porting/p4gpc-vita/font-conversion/personaeditorwindow.png)

Once opened, right click the .fnt file and click Save As. In the new window change the file type to PNG.

 ![](/assets/images/porting/p4gpc-vita/font-conversion/saveoption.png)
...
The editor window looks like this:
   ...
   ![](/assets/images/porting/p4gpc-vita/font-conversion/personaeditorfontpreview.png)
...
A good frame of reference is to align the Left Cut to be touching the most outer light edge of the character, and the Right Cut to be one pixel away from the edge of the character. Like this:
 ...
 ![](/assets/images/porting/p4gpc-vita/font-conversion/cutalignment.png)
...
[Here](/assets/images/porting/p4gpc-vita/font-conversion/FONT TEST.7z) you can download a flowscript mod I made that adds dialogue to the kitchen sink in your house, allowing you to quickly check all characters, as well as how they look in sentences. 
   ...
   ![](/assets/images/porting/p4gpc-vita/font-conversion/fonttesttoolcapital.png)

   ![](/assets/images/porting/p4gpc-vita/font-conversion/fonttesttoollowercase.png)

  ![](/assets/images/porting/p4gpc-vita/font-conversion/fonttestdog.png)

  ![](/assets/images/porting/p4gpc-vita/font-conversion/fonttestquartz.png)
...
Broken text like this is indicative of incorrect spacing with font mods. If your text looks like this, make sure you actually saved your spacing changes in Persona Editor before packaging.
  ...
  ![](/assets/images/porting/p4gpc-vita/font-conversion/dojimabadexample.png)

  ![](/assets/images/porting/p4gpc-vita/font-conversion/nanakobadexample.png)

Correct font spacing looks like this. 

Here I am demonstrating with the Comic Sans font mod that I ported for this tutorial.

  ![](/assets/images/porting/p4gpc-vita/font-conversion/comicsanscapital.png)

  ![](/assets/images/porting/p4gpc-vita/font-conversion/comicsanslowercase.png)

  ![](/assets/images/porting/p4gpc-vita/font-conversion/comicsansdog.png)

  ![](/assets/images/porting/p4gpc-vita/font-conversion/comicsansquartz.png)
