...
<Tabs>
<TabItem value="model-conversion-hd" label="HD Models">
...
First, let's open the model in GMOView to check how the model looks before getting started.
 ...
 ![](/assets/images/porting/p4gpc-vita/model-conversion/modelpreview.png)
...
Read the first line, the first 3 letters on the right are the true extension.
  ...
  ![](/assets/images/porting/p4gpc-vita/model-conversion/hxdfileextension.png)
...
```
  ![](/assets/images/porting/p4gpc-vita/model-conversion/commandprompttexture.png)
...
Your textures colors should be fixed, as shown here.
  ...
  ![](/assets/images/porting/p4gpc-vita/model-conversion/oldprincipalitytexture.png)

  ![](/assets/images/porting/p4gpc-vita/model-conversion/newprincipalitytexture.png)
...
You should find your texture listed like this:
  ...
  ![](/assets/images/porting/p4gpc-vita/model-conversion/texturementiongms.png)
...
Now, we need to remove the junk data leftover from the original poster, remove everything before the texture file like this:
  ...
  ![](/assets/images/porting/p4gpc-vita/model-conversion/removedjunkdata.png)

Then, change the extension to .TM2

 ![](/assets/images/porting/p4gpc-vita/model-conversion/changedextension.png)
...
This will turn your GMS into a GMO, let's take the time to preview our model in GMOView to ensure the textures were applied properly.
 ...
 ![](/assets/images/porting/p4gpc-vita/model-conversion/fixedtextures.png)
...
You'll know if your model has vertex colors if you see a C32 / C16 value in the format section in the top left of GMOView.
  ...
  ![](/assets/images/porting/p4gpc-vita/model-conversion/vertexcolormention.png)
...
This will remove vertex colors at the sacrifice of a slight loss in brightness. As shown here.
  ...
  ![](/assets/images/porting/p4gpc-vita/model-conversion/fixedvertexcolors.png)
...
<TabItem value="model-conversion-apply" label="Applying Textures">
W.I.P
</TabItem>
<TabItem value="model-conversion-simplefixing" label="Simple Fixing">
W.I.P
</TabItem>
</Tabs>