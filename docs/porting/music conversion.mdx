...
Download the mod of your choosing and navigate through the folders until you find the .raw file. You should find a .txth file next to it, like this:
 ...
 ![](/assets/images/porting/p4gpc-vita/music-conversion/filelist.png)
...
Next, right click the file and click Convert then Quick Convert, then select WAV as your export option.
 ...
 ![](/assets/images/porting/p4gpc-vita/music-conversion/foobarexport.png)

 ![](/assets/images/porting/p4gpc-vita/music-conversion/wavoption.png)
...
Your command should look something like this:
 ...
 ![](/assets/images/porting/p4gpc-vita/music-conversion/at9toolcommand.png)
...
Inside pf the newly extracted folder are all of the AT9 files for the base game. You don't want to permanently mess with these in the off chance you'd be interested in doing other sound mods later, so it's a safe idea to make a copy of the ACB, AWB, and folder to another location.
 ...
 ![](/assets/images/porting/p4gpc-vita/music-conversion/at9list.png)
...
Your path should look like this:
 ...
 ![](/assets/images/porting/p4gpc-vita/music-conversion/aemuluspath.png)
...
* I can't seem to locate the BGM files at the path you listed.
  * You need to have a completely unpacked base game to find the file, as Aemulus doesn't extract those files. You can go [here](../getting-started/extracting-files.mdx) to find out how to extract the base files. You should already have a decrypted data.cpk from doing the modding process.