...
Preview your video in a MP4 player of choice before continuing.
 ...
 ![](/assets/images/porting/p4gpc-vita/video-conversion/mp4preview.png)
...
<TabItem value="p4gvitavideossummary" label="Summary">
 ![](/assets/images/porting/p4gpc-vita/video-conversion/summarysettings.png)
</TabItem>

<TabItem value="p4gvitavideosdimensions" label="Dimensions">
 ![](/assets/images/porting/p4gpc-vita/video-conversion/dimensionssettings.png)
</TabItem>

<TabItem value="p4gvitavideosvideo" label="Video">
 ![](/assets/images/porting/p4gpc-vita/video-conversion/videosettings.png)
</TabItem>
</Tabs>
...
Go back up to the top and press the green play button to start encoding.
 ...
 ![](/assets/images/porting/p4gpc-vita/video-conversion/encodingbutton.png)
...
Launch back into the game and instead of continuing into game, select TV Listings. 
 ...
 ![](/assets/images/porting/p4gpc-vita/video-conversion/mainmenu.png)

Next, select Daily Personamations. 

  ![](/assets/images/porting/p4gpc-vita/video-conversion/tvlistingsview.png)

Inside you'll find a list of all cutscenes in game, able to be played at any time.

 ![](/assets/images/porting/p4gpc-vita/video-conversion/dailypersonamations.png)

 ![](/assets/images/porting/p4gpc-vita/video-conversion/cutscenelist.png)
