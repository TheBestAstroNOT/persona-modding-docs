...
var WarningIcon = (props) => {
  return React2.createElement(
    ...
    React2.createElement("path", { d: "M11.001 10h2v5h-2zM11 16h2v2h-2z" }),
    React2.createElement("path", { d: "M13.768 4.2C13.42 3.545 12.742 3.138 12 3.138s-1.42.407-1.768 1.063L2.894 18.064a1.986 1.986 0 0 0 .054 1.968A1.984 1.984 0 0 0 4.661 21h14.678c.708 0 1.349-.362 1.714-.968a1.989 1.989 0 0 0 .054-1.968L13.768 4.2zM4.661 19 12 5.137 19.344 19H4.661z" })
  );
};
var RestartWarning = () => {
  return React2.createElement("p", { className: "rounded-lg border shadow px-4 py-2.5 bg-gradient-to-r from-yellow-50 to-yellow-100 border-yellow-200 mb-4" }, React2.createElement("div", { className: "flex items-center gap-2" }, React2.createElement(WarningIcon, { className: `w-6 h-auto flex-shrink-0 text-yellow-400` }), React2.createElement("div", { className: `flex-1 text-sm text-yellow-700 whitespace-normal	` }, "To see settings changes reflected on your site, restart the Tina CLI after saving ", React2.createElement("em", null, "(local development only)"), ".")));
};
var PostCollection = {
  name: "post",
  label: "Posts",
  ...
  fields: [
    {
      ...
      ui: {
        component: () => {
          return React2.createElement(RestartWarning, null);
        }
      }
    },
    {
